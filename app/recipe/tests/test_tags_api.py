...
class PrivateTagsApiTests(TestCase):
    ...
    def test_tags_limited_to_user(self):
        ...
        user2 = create_user(email="user2@example.com", password="usertest123")
    ...
    def test_filtered_tags_unique(self):
        ...
        tag = Tag.objects.create(user=self.user, name="Taste")
